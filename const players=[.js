...
// obtener  jugadores de arsenal
var arsenal = players.filter(player=>player.team === "Arsenal")
console.log(arsenal.length)
//  first_name + last_name => full_name
// identificador => x

const modArsenal = arsenal.map(player=>{
    return {
...
console.log(modArsenal)

const modArsenal2 = arsenal.map(((first_name, last_name, identifier, image) => ({
        full_name: `${first_name} ${last_name}`,
         identifier,
       image
    
})))
console.log(modArsenal2)
